  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="搜索：">
        <el-input size="small" v-model="formInline.machineNo" placeholder="输入日志名称"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input size="small" v-model="formInline.orderNo" placeholder="输入描述"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input size="small" v-model="formInline.orderNo" placeholder="输入上传用户名"></el-input>
      </el-form-item>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="machineNo" label="编号" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="orderNo" label="日志名称" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="transId" label="上传日期" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="transType" label="上传用户" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="payType" label="日志描述" width="140" show-overflow-tooltip>
      </el-table-column>
